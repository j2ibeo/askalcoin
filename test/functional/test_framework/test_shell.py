...
class TestShell:
    """Wrapper Class for AskalcoinTestFramework.

    The TestShell class extends the AskalcoinTestFramework
    ...
    class __TestShell(AskalcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by AskalcoinTestFramework child class.
            self.num_nodes = 1
