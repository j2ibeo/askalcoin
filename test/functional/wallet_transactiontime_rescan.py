#!/usr/bin/env python3
# Copyright (c) 2018-2019 The Askalcoin Core developers
...
class TransactionTimeRescanTest(AskalcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine STC and create transactions
        ...
        # generate some stc to create transactions and check blockcount
        ...
        # send 10 stc to user's first watch-only address
        self.log.info('Send 10 stc to user')
        ...
        # send 5 stc to our second watch-only address
        self.log.info('Send 5 stc to user')
        ...
        # send 1 stc to our third watch-only address
        self.log.info('Send 1 stc to user')
