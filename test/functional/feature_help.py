...
"""Verify that starting askalcoin with -h works as expected."""

from test_framework.test_framework import AskalcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(AskalcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start askalcoin with -h for help text")
        ...
        self.log.info("Start askalcoin with -version for version information")
        ...
        self.log.info("Start askalcoind with -fakearg to make sure it does not start")
