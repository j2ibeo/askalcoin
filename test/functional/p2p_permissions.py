...
class P2PPermissionsTests(AskalcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].askalcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].askalcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
