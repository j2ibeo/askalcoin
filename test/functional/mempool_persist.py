...
By default, askalcoind will dump mempool on shutdown and
...
class MempoolPersistTest(AskalcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent askalcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
