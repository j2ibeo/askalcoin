...
class TxnMallTest(AskalcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 STC:
        ...
        # First: use raw transaction API to send 1240 STC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 STC coin each
