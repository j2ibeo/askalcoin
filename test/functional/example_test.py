...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AskalcoinTestFramework
    pass


class ExampleTest(AskalcoinTestFramework):
    # Each functional test is a subclass of the AskalcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        AskalcoinTestFramework class so other tests can use it."""
