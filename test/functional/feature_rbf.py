...
class ReplaceByFeeTest(AskalcoinTestFramework):
    ...
    def run_test(self):
        ...
        # 76-100 (see method AskalcoinTestFramework._initialize_chain())
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 4 STC - so this attempt is rejected.
        dbl_tx = CTransaction()
