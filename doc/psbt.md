# PSBT Howto for Askalcoin Core

Since Askalcoin Core 0.17, an RPC interface exists for Partially Signed Askalcoin
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/askalcoin/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Askalcoin transactions that are not fully signed
...
#### Multisig with multiple Askalcoin Core instances
...
Askalcoin Core. We assume their wallets only contain the multisig funds. In case
they also have a personal wallet, this can be accomplished through the
multiwallet feature - possibly resulting in a need to add `-rpcwallet=name` to
the command line in case `askalcoin-cli` is used.
...
Later, when *V* STC has been received on *Amulti*, and Bob and Carol want to
