Askalcoin Core version *0.15.2* is now available from:

  <https://askalcoincore.org/bin/askalcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in askalcoin-tx (TheBlueMatt)
