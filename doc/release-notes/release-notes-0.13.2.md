Askalcoin Core version 0.13.2 is now available from:

  <https://askalcoin.org/bin/askalcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update askalcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow askalcoin-tx to create v2 transactions (stcdrak)
