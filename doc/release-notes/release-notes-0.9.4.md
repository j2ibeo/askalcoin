Askalcoin Core version 0.9.4 is now available from:

  https://askalcoin.org/bin/0.9.4/
...
this update is incompatible with the Askalcoin system and could lead to consensus
forks.

Askalcoin Core released binaries from https://askalcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~askalcoin/+archive/ubuntu/askalcoin
- A third-party or self-compiled Askalcoin Core

upgrade to Askalcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
