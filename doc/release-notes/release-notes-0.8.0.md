Askalcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/askalcoin/files/Askalcoin/askalcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Askalcoin
...
New/changed settings (command-line or askalcoin.conf file)
--------------------------------------------------------
