Askalcoin Core version 0.9.2.1 is now available from:

  https://askalcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 STC to 0.01 STC
...
- Fix "Start askalcoin on system login"
