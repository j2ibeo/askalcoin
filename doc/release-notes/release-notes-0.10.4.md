Askalcoin Core version 0.10.4 is now available from:

  <https://askalcoin.org/bin/askalcoin-core-0.10.4/>
...
- #6953 `43c2789` Split askalcoin-tx into its own package
- #6953 `dfe0d4d` Include askalcoin-tx binary on Debian/Ubuntu
