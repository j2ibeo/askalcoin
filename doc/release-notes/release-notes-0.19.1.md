...
Askalcoin Core version 0.19.1 is now available from:

  <https://askalcoincore.org/bin/askalcoin-core-0.19.1/>
...
From Askalcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Askalcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Askalcoin Core does not yet change appearance when
...
- #17488 fix "askalcoind already running" warnings on macOS (fanquake)
