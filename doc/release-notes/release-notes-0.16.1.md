Askalcoin Core version 0.16.1 is now available from:

  <https://askalcoincore.org/bin/askalcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting askalcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure askalcoind processes are cleaned up when tests end (sdaftuar)
