Askalcoin Core version *0.15.0.1* is now available from:

  <https://askalcoin.org/bin/askalcoin-core-0.15.0.1/>

and

  <https://askalcoincore.org/bin/askalcoin-core-0.15.0.1/>
