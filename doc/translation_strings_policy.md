...
This document provides guidelines for internationalization of the Askalcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `askalcoin_en.ts` remains unchanged.
