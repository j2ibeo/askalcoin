...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the askalcoin repository."
  exit 1
fi
...
# See https://github.com/askalcoin/askalcoin/issues/16064
...
echo 'When compiling askalcoind, run `./configure` in the following way:'
echo
