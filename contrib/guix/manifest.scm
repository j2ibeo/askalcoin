...
(define* (make-askalcoin-cross-toolchain target
                                       #:key
...
desirable for building Askalcoin Core release binaries."
...
(define glibc-2.27/askalcoin-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-askalcoin-cross-toolchain target
                                                      #:base-libc glibc-2.27/askalcoin-patched
