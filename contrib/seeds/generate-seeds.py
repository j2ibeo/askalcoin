...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef ASKALCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define ASKALCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the askalcoin network\n')
    ...
    g.write('#endif // ASKALCOIN_CHAINPARAMSSEEDS_H\n')
