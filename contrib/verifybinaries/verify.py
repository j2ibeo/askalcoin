...
"""Script for verifying Askalcoin Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
askalcoincore.org and askalcoin.org and compares them.
...
WORKINGDIR = "/tmp/askalcoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://askalcoincore.org"
HOST2 = "https://askalcoin.org"
VERSIONPREFIX = "askalcoin-core-"
...
def main(args):
    ...
    if not success:
        print("askalcoin.org failed to provide signature file, "
              "but askalcoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("askalcoin.org and askalcoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Askalcoin Core binary release "
