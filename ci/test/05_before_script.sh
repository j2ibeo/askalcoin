...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Askalcoin
else
  DOCKER_EXEC echo \> \$HOME/.askalcoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/askalcoin/askalcoin/pull/18288#discussion_r433189350 for
  # details.
