// Copyright (c) 2020-2021 The Askalcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ASKALCOIN_INDEX_COINSTATSINDEX_H
#define ASKALCOIN_INDEX_COINSTATSINDEX_H
...
#endif // ASKALCOIN_INDEX_COINSTATSINDEX_H
