    ...
    mapper(nullptr)
{
    ...
    ui->askalcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->askalcoinAtStartup);
    ...
    ui->askalcoinAtStartup->setToolTip(ui->askalcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->askalcoinAtStartup->setText(ui->askalcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openAskalcoinConfButton->setToolTip(ui->openAskalcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new AskalcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->askalcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openAskalcoinConfButton_clicked()
{
