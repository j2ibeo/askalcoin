...
#ifndef ASKALCOIN_QT_GUIUTIL_H
#define ASKALCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Askalcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "askalcoin:" URI into recipient object, return true on successful parsing
