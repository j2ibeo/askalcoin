...
#ifndef ASKALCOIN_QT_WALLETVIEW_H
#define ASKALCOIN_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a askalcoin wallet, and offers access to
...
#endif // ASKALCOIN_QT_WALLETVIEW_H
