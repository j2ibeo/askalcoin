...
#ifndef ASKALCOIN_QT_ASKALCOINGUI_H
#define ASKALCOIN_QT_ASKALCOINGUI_H
...
/**
  Askalcoin GUI main class. This class represents the main window of the Askalcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class AskalcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit AskalcoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~AskalcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a askalcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Askalcoin Transaction from file or clipboard */
...
#endif // ASKALCOIN_QT_ASKALCOINGUI_H
