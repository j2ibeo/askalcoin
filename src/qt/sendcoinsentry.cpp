    ...
    platformStyle(_platformStyle)
{
    ...
    // normal askalcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying askalcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &AskalcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
