...
//! Entry point for AskalcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &AskalcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for AskalcoinGUI tests.
void AppTests::guiTests(AskalcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &AskalcoinGUI::consoleShown, this, &AppTests::consoleTests);
