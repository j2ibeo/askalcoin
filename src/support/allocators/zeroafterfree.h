...
#ifndef ASKALCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define ASKALCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // ASKALCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
