...
#ifndef ASKALCOIN_NET_H
#define ASKALCOIN_NET_H
 ...
 * src/qt/guiutil.cpp and src/askalcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Askalcoin’s Peer-to-Peer Network")
