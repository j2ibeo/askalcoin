...
#ifndef ASKALCOIN_COMPAT_ASSUMPTIONS_H
#define ASKALCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Askalcoin cannot be compiled without assertions."
#endif
...
#endif // ASKALCOIN_COMPAT_ASSUMPTIONS_H
