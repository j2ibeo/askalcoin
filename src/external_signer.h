// Copyright (c) 2018-2021 The Askalcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ASKALCOIN_EXTERNAL_SIGNER_H
#define ASKALCOIN_EXTERNAL_SIGNER_H
...
#endif // ASKALCOIN_EXTERNAL_SIGNER_H
