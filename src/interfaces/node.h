...
#ifndef ASKALCOIN_INTERFACES_NODE_H
#define ASKALCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a askalcoin node (askalcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // ASKALCOIN_INTERFACES_NODE_H
