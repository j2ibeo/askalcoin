...
#ifndef ASKALCOIN_INTERFACES_INIT_H
#define ASKALCOIN_INTERFACES_INIT_H
...
//! (askalcoin-gui, askalcoin-node, askalcoin-wallet, askalcoind, askalcoin-qt) and each
...
#endif // ASKALCOIN_INTERFACES_INIT_H
