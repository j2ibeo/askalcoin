...
#ifndef ASKALCOIN_TEST_SCRIPTNUM10_H
#define ASKALCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Askalcoin Core 0.10.0, for cross-comparison.
 */
public:
