...
#ifndef ASKALCOIN_UTIL_SYSCALL_SANDBOX_H
#define ASKALCOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during askalcoind initialization if Askalcoin Core was compiled
...
#endif // ASKALCOIN_UTIL_SYSCALL_SANDBOX_H
