 ...
 */
#ifndef ASKALCOIN_UTIL_SYSTEM_H
#define ASKALCOIN_UTIL_SYSTEM_H
...
extern const char * const ASKALCOIN_CONF_FILENAME;
extern const char * const ASKALCOIN_SETTINGS_FILENAME;
