...
#ifndef ASKALCOIN_UTIL_MESSAGE_H
#define ASKALCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's askalcoin address, it must refer to a public key.
...
#endif // ASKALCOIN_UTIL_MESSAGE_H
