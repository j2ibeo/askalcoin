...
#ifndef ASKALCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define ASKALCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // ASKALCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
