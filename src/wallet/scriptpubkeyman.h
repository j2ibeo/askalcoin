...
#ifndef ASKALCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define ASKALCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Askalcoin Core wallet was originally a collection of unrelated private
...
#endif // ASKALCOIN_WALLET_SCRIPTPUBKEYMAN_H
