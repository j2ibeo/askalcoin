...
#ifndef ASKALCOIN_WALLET_WALLETUTIL_H
#define ASKALCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! askalcoin from opening the wallet, thinking it was newly created, and
...
#endif // ASKALCOIN_WALLET_WALLETUTIL_H
