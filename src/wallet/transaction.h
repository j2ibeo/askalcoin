...
#ifndef ASKALCOIN_WALLET_TRANSACTION_H
#define ASKALCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this askalcoin node, and set to 0 for transactions that were created
...
#endif // ASKALCOIN_WALLET_TRANSACTION_H
