...
#ifndef ASKALCOIN_WALLET_ISMINE_H
#define ASKALCOIN_WALLET_ISMINE_H
 ...
 * https://github.com/askalcoin/askalcoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // ASKALCOIN_WALLET_ISMINE_H
