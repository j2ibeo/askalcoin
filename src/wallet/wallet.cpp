...
CWalletTx* CWallet::AddToWallet(CTransactionRef tx, const CWalletTx::Confirmation& confirm, const UpdateWalletTxFn& update_wtx, bool fFlushOnClose, bool rescanning_old_block)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/askalcoin/askalcoin/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/askalcoin/askalcoin/pull/13339#issuecomment-461288094
...
void CWallet::transactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason, uint64_t mempool_sequence) {
    ...
    if (reason == MemPoolRemovalReason::CONFLICT) {
        ...
        //    https://github.com/askalcoin/askalcoin/pull/18600#discussion_r420195993.
        ...
        //    https://github.com/askalcoin/askalcoin/pull/9371 and the prior sync
        ...
        // https://github.com/askalcoin-core/askalcoin-devwiki/wiki/Wallet-Transaction-Conflict-Tracking
        SyncTransaction(tx, {CWalletTx::Status::UNCONFIRMED, /*block_height=*/0, /*block_hash=*/{}, /*block_index=*/0});
    }
}
 ...
 * https://askalcointalk.org/?topic=54527, or
 * https://github.com/askalcoin/askalcoin/pull/1393.
 */
