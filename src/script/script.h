...
#ifndef ASKALCOIN_SCRIPT_SCRIPT_H
#define ASKALCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Askalcoin always counted CHECKMULTISIGs
...
#endif // ASKALCOIN_SCRIPT_SCRIPT_H
