...
#ifndef ASKALCOIN_SCRIPT_STANDARD_H
#define ASKALCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a askalcoin address
 */
...
/**
 * Generate a Askalcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // ASKALCOIN_SCRIPT_STANDARD_H
