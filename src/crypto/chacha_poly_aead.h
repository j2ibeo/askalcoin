...
#ifndef ASKALCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define ASKALCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@askalcoin.
 *
 ...
 *
 * The chacha20-poly1305@askalcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@askalcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@askalcoin are relatively fast in
...
#endif // ASKALCOIN_CRYPTO_CHACHA_POLY_AEAD_H
